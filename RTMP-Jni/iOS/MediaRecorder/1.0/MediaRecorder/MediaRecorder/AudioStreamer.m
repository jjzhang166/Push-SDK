                            ...
                            UInt32 *                                                ioFlags)
{
    ...
    AudioStreamer* myData = (__bridge AudioStreamer*)inClientData;
    OSStatus err = noErr;
    ...
    switch (inPropertyID) {
        case kAudioFileStreamProperty_ReadyToProducePackets :
        {
            ...
            err = AudioQueueNewOutput(&asbd, MyAudioQueueOutputCallback, (__bridge void * _Nullable)(myData), NULL, NULL, 0, &myData->audioQueue);
            if (err) { PRINTERROR("AudioQueueNewOutput"); myData->failed = true; break; }
            
            // listen to the "isRunning" property
            err = AudioQueueAddPropertyListener(myData->audioQueue, kAudioQueueProperty_IsRunning, MyAudioQueueIsRunningCallback, (__bridge void * _Nullable)(myData));
...
void MyAudioQueueIsRunningCallback(void *inUserData, AudioQueueRef inAQ, AudioQueuePropertyID inID)
{
    AudioStreamer *myData = (__bridge AudioStreamer *)inUserData;
