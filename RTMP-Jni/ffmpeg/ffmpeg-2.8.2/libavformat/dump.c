...
#if 0
printf("Eoollo %s:Line %d bit_rate %d\n", __func__, __LINE__, st->codec->bit_rate);
printf("Eoollo %s:Line %d st avg den %d num %d fps %d\n", __func__, __LINE__, st->avg_frame_rate.den, st->avg_frame_rate.num, fps);
printf("Eoollo %s:Line %d st r den %d num %d tbr %d\n", __func__, __LINE__, st->r_frame_rate.den, st->r_frame_rate.num, tbr);
printf("Eoollo %s:Line %d st time_base den %d num %d tbn %d\n", __func__, __LINE__, st->time_base.den, st->time_base.num, tbn);
printf("Eoollo %s:Line %d st codec time_base den %d num %d tbc %d\n", __func__, __LINE__, st->codec->time_base.den, st->codec->time_base.num, tbc);
#endif
