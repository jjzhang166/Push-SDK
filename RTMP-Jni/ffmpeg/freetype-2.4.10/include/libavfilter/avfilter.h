 ...
 */
 ...
 /**
 * Draw text util function, draw text on given frame
 * @param fontfile  free type font file
 * @param color  font color("White"/"#FFAAAABB"/"0xffab494c").
 * @param size  font size
 * @param text alpha (value:0~1)
 *
 * @param frame  target frame
 * @param text  text content to render
 * @param x  axis x value of position
 * @param y  axis y value of position
 * @param align 0:left, 1:center, 2:right
 * @param text_rect_w text rect width
 * @param text_rect_h text rect height
 *
 * @return  return 0 on success, error when < 0
 */
