package com.wangyong.demo.pushsdk.RESVideoTools.Filters;
...
import com.wangyong.demo.pushsdk.RESVideoTools.Tools.GLESTools;
...
public class GPUImageCompatibleFilter<T extends GPUImageFilter> extends BaseHardVideoFilter {
    ...
    public void onInit(int VWidth, int VHeight) {
        ...
        innerGPUImageFilter.onInputSizeChanged(VWidth, VHeight);
    }

    @Override
    public void onDraw(int cameraTexture, int targetFrameBuffer, FloatBuffer shapeBuffer, FloatBuffer textrueBuffer) {
        GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, targetFrameBuffer);
        innerGPUImageFilter.onDrawFrame(cameraTexture, innerShapeBuffer, innerTextureBuffer);
