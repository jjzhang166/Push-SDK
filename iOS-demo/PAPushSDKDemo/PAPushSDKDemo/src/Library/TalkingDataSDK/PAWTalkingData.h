//
//  TalkingData.h
//  __MyProjectName__ Version 2.0.16
//
...
// 以下枚举用于WatchApp页面追踪
typedef enum {
    PAWTDPageTypeGlance = 1,
    PAWTDPageTypeNotification = 2,
    PAWTDPageTypeWatchApp = 3
} PAWTDPageType;

@interface PAWTalkingData: NSObject
 ...
 */
+ (void)trackPageBegin:(NSString *)pageName withPageType:(PAWTDPageType)pageType;
