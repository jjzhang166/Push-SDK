...
//
//- (void)setImageOrientation:(UIImageOrientation)imageOrientation
//{
...
-(CVPixelBufferRef)PixelBufferOutput{
...
//	}
    ...
    return [self imageFromCurrentFramebufferWithOrientation:_imageOrientation];
}
