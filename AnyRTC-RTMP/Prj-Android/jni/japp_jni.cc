...
JOWW(void, RTMPHosterKit_nativeSetAudioParam)(JNIEnv* jni, jobject j_app, jint sampleRate, jint sampleBit, jint channels)
{
	JRTMPHosterImpl* jApp = (JRTMPHosterImpl*)GetJApp(jni, j_app);
	jApp->Hoster()->SetAudioParam(sampleRate, sampleBit, channels);
}

JOWW(void, RTMPHosterKit_nativeSetVideoParam)(JNIEnv* jni, jobject j_app, jint resolution, jint fps, jint bitRate)
{
	JRTMPHosterImpl* jApp = (JRTMPHosterImpl*)GetJApp(jni, j_app);
	jApp->Hoster()->SetVideoParam(resolution, fps, bitRate);
}
...
JOWW(void, RTMPHosterKit_nativeSetVideoCapturer)(JNIEnv* jni, jobject j_app, jobject j_egl_context, jobject j_video_capturer, jlong j_renderer_pointer)
{
	JRTMPHosterImpl* jApp = (JRTMPHosterImpl*)GetJApp(jni, j_app);
...
JOW(void, VideoRenderer_releaseNativeFrame)(
    ...
    LOG(LS_ERROR) << "VideoRenderer_releaseNativeFrame";
