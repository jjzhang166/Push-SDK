...
public class MediaCodecVideoEncoder {
  ...
  private static final MediaCodecProperties huaweiH264HwProperties = new MediaCodecProperties(
          "OMX.IMG.TOPAZ", Build.VERSION_CODES.KITKAT, false /* bitrateAdjustmentRequired */);
  private static final MediaCodecProperties MTKH264HwProperties = new MediaCodecProperties(
          "OMX.MTK.VIDEO", Build.VERSION_CODES.KITKAT, false /* bitrateAdjustmentRequired */);
  private static final MediaCodecProperties[] h264HwList = new MediaCodecProperties[] {
    qcomH264HwProperties, exynosH264HwProperties, rkH264HwProperties, huaweiH264HwProperties, MTKH264HwProperties
  };
  ...
  private static EncoderProperties findHwEncoder(
    ...
    for (int i = 0; i < MediaCodecList.getCodecCount(); ++i) {
      ...
      Logging.e(TAG, "Found candidate encoder " + name);
