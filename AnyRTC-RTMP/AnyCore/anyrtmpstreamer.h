...
public:
    ...
    virtual void SetAudioParameter(int a_sample_hz_, int bitpersample, int a_channels_);
...
public:
	//* For AVCodecCallback
	virtual void OnEncodeDataCallback(bool audio, uint8_t *p, uint32_t length, uint32_t ts, uint32_t *delayMs);
